"""reorder_games_team_score_flow

Revision ID: 5efe4f23e531
Revises: a1aedd3558f3
Create Date: 2025-11-25 06:18:00.000000
...
revision: str = '5efe4f23e531'
down_revision: Union[str, None] = 'a1aedd3558f3'
...
def upgrade() -> None:
    ...
    # Recreate games table with better column flow: team name, score, team name, score, winner
    op.execute("""
